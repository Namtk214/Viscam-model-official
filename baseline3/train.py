...
Train a Vietnamese scam detection model using AITeamVN Vietnamese Embedding
(AITeamVN/Vietnamese_Embedding) with two stages:
...
def parse_args():
    parser = argparse.ArgumentParser(
        description="Train Vietnamese scam detection model with AITeamVN embedding (two-stage pipeline)",
...
def main():
    ...
    # ── Load data ───────────────────────────────────────────────────────
    print("\n" + "=" * 70)
    print("VIETNAMESE SCAM DETECTION - AITeamVN EMBEDDING")
    print("=" * 70)
