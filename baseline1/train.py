...
Train a Vietnamese scam detection model using SentenceTransformer backbone
(dangvantuan/vietnamese-embedding) with two stages:
...
def parse_args():
    parser = argparse.ArgumentParser(
        description="Train Vietnamese scam detection model (two-stage pipeline)",
...
def main():
    ...
    # ── Load data ───────────────────────────────────────────────────────
    print("\n" + "=" * 70)
    print("VIETNAMESE SCAM DETECTION - TWO-STAGE PIPELINE")
    print("=" * 70)
