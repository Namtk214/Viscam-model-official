...
Train a Vietnamese scam detection model using BKAI Vietnamese Bi-Encoder
(bkai-foundation-models/vietnamese-bi-encoder) with two stages:
...
def parse_args():
    parser = argparse.ArgumentParser(
        description="Train Vietnamese scam detection model with BKAI encoder (two-stage pipeline)",
...
def main():
    ...
    # ── Load data ───────────────────────────────────────────────────────
    print("\n" + "=" * 70)
    print("VIETNAMESE SCAM DETECTION - BKAI BI-ENCODER")
    print("=" * 70)
